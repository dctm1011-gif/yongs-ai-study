...
- puzzle: 2~5글자 한국어 단어 정확히 10개. 대상은 한국어 원어민 성인. 목표: 최상위권 어휘력 확장.
  난이도 기준 — 아래 범주에서만 선택:
  ① 고급 한자어: 핍진(逼眞), 준엄(峻嚴), 명징(明澄), 혜안(慧眼), 경구(警句), 해학(諧謔), 완명(頑冥), 비루(鄙陋), 천착(穿鑿), 옹졸(壅拙) 수준
  ② 인문·철학 전문어: 변증, 귀납, 소격, 승화, 전이, 기시, 부조리, 형이상, 아포리아 수준
  ③ 고어·문어(文語): 일상 대화에서 거의 쓰이지 않는 조선시대 문헌 수준 어휘
  ④ 법률·의학·언어학 전문 한자어: 대위, 준거, 면책, 유추, 반증, 전치, 배치 수준
  ※ 절대 금지: 나비, 거울, 밤, 달, 별 같은 기초 어휘. 관조·침잠·융통 같은 중급 어휘도 금지.
  clue는 사전적 정의 + 한자(있으면) 표기. 단어끼리 공통 글자가 있도록 해서 크로스워드 교차 가능.`;
