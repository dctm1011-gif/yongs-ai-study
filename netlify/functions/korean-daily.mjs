...
- puzzle: 2~5글자 한국어 단어 정확히 10개. 한국인 성인의 어휘력 향상 목적. 일상에서 잘 안 쓰이는 고급 어휘 위주로 — 한자어, 문학어, 전문용어(인문/철학/법/의학 등), 고어(古語), 사자성어 파생어 등. 각 단어의 뜻을 힌트로. 단어끼리 교차 배치가 가능하도록 공통 글자가 있는 단어 포함.`;
