  ...
  return [
    {
      ...
      sections: [
        {
          heading: '시장 동향',
          body: `부동산 시장이 금리 인하 기대감에 힘입어 긍정적 신호를 보이고 있습니다.
...
- 외국인 투자 관심 증대`,
        ...
        {
          heading: '전망과 시사점',
          body: '금리 인하 기대감과 도시 개발 호재가 맞물리면서 중기적 상승세가 예상됩니다. 앞으로 2-3개월이 부동산 투자의 중요한 타이밍이 될 것으로 예상됩니다.',
        },
      ],
      outlook: 'positive',
      readTime: 5,
    ...
    },
    {
      ...
      sections: [
        {
          heading: '시장 동향',
          body: `AI 시장의 급성장이 반도체 업계에 미치는 영향은 지대합니다.
...
- 향후 3년 동안 성장성 높음`,
        ...
        {
          heading: '전망과 시사점',
          body: 'AI 혁명의 초반부이며, 반도체 수요는 계속 증가할 것으로 전망됩니다. AI 칩 시장은 10년 이상의 성장 사이클이 예상되고 있습니다.',
        },
      ],
      outlook: 'positive',
      readTime: 6,
