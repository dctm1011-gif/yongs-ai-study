...
1. 부동산: 서울, 인천, 경기 각 지역의 최근 아파트 평균 매매가 동향 (최근 뉴스/실거래가 기준)
  ...
  "columns": [
    {{
      ...
      "chartData": [
        ...
        {{"title": "인천 아파트 평균 매매가 추이", "unit": "단위: 억원", "data": [...5개월치...]}},
        {{"title": "경기 아파트 평균 매매가 추이", "unit": "단위: 억원", "data": [...5개월치...]}}
      ]
    }},
    {{
      "id": "col-stocks-{today}",
...
부동산 칼럼의 chartData는 반드시 서울/인천/경기 3개 항목이어야 하고, 각 항목의 실제 수치는 검색으로 확인한 값에 최대한 가깝게 추정해줘. 숫자를 모르면 최근 시세 기준으로 합리적으로 추정."""
